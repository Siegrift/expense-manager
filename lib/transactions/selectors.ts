...
import { filterFunctionFromCodeSel, frozenFilterDataSel } from '../filters/selectors'
import { COMMANDS, isCommandWithValidation, isValidQuery, search } from '../search/transactionSearch'
...
export const transactionByIdSel = (id: string) => createSelector(transactionsSel, (txs) => txs[id])
...
export const isValidQuerySel = createSelector(querySel, (query) => isValidQuery(query))
...
export const confirmTxDeleteDialogOpenSel = (state: State) => state.confirmDeleteTxForTxId
