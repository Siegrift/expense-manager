...
import { csvFromDataSel, dataFromImportedCsvSel, dataFromImportedJsonSel } from './importExportSelectors'
...
describe('settings actions', () => {
  describe('import/export', () => {
    ...
    describe('json', () => {
      ...
      test('checks for errors', () => {
        const checkError = (input: string) => dataFromImportedJsonSel(input)(state).errorReason
        ...
        ).toBe(`Imported data would override current data. Specifically, field 'tags' with id 'id'`)
        expect(
          checkError(
